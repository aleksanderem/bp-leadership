    ...
    private static function register_leadership_fields() {
        acf_add_local_field_group([
            ...
            'fields'   => [
                ...
                [
                    'key'           => 'field_grid_cols_desktop',
                    'label'         => 'Stories Grid — Desktop',
                    'name'          => 'grid_cols_desktop',
                    'type'          => 'select',
                    'choices'       => [
                        '4' => '4 Columns',
                        '3' => '3 Columns',
                    ...
                    'allow_null'    => 0,
                    'return_format' => 'value',
                    'instructions'  => 'Number of columns for the stories grid on desktop.',
                ],
                [
                    'key'           => 'field_grid_cols_tablet',
                    'label'         => 'Stories Grid — Tablet',
                    'name'          => 'grid_cols_tablet',
                    'type'          => 'select',
                    'choices'       => [
                        'inherit' => 'Inherit from Desktop',
                        '4'       => '4 Columns',
                        '3'       => '3 Columns',
                        '2'       => '2 Columns',
                        '1'       => '1 Column',
                    ...
                    'allow_null'    => 0,
                    'return_format' => 'value',
                    'instructions'  => 'Number of columns on tablet (≤1024px). "Inherit" uses the desktop value.',
                ],
                [
                    'key'           => 'field_grid_cols_mobile',
                    'label'         => 'Stories Grid — Mobile',
                    'name'          => 'grid_cols_mobile',
                    'type'          => 'select',
                    'choices'       => [
                        'inherit' => 'Inherit from Tablet',
                        '4'       => '4 Columns',
                        '3'       => '3 Columns',
                        '2'       => '2 Columns',
                        '1'       => '1 Column',
                    ...
                    'allow_null'    => 0,
                    'return_format' => 'value',
                    'instructions'  => 'Number of columns on mobile (≤767px). "Inherit" uses the tablet value.',
                ],
            ],
            'location' => [
                [
